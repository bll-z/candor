...
const home = () => (
    <div className="home candor-page">
        <div className="candor-content home-content-top">
        ...
        <div className="candor-content home-content-bottom">
            ...
            <a onClick={() => document.getElementById("google-map").scrollIntoView()}>
                <img class="google-thumb" src="/static/images/google-maps.png" />
            </a>
        </div>
        <iframe id="google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2991.8320341775147!2d-81.52153914876061!3d41.421164679159375!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88311d0da9837929%3A0x3ff4a7704b353992!2sCandor+Logistics!5e0!3m2!1sen!2sus!4v1526586417164" frameBorder="0" />
