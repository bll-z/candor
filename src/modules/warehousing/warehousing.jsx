...
const warehousing = () => (
	<div className="candor-content candor-page warehousing">
		...
		<div className="candor-paragraph">How does having the ability to concentrate on your core business sound? In other words, do what you do best. It's a major advantage to outsource your warehousing to Candor Logistics and Warehousing.</div>
